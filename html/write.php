...
<main class="pt-20 mx-auto max-w-3xl">
    <?php echo <<<HTML
    <form method="POST" enctype="multipart/form-data" id="post-form" action="actions/create_post.php" class="p-6 flex flex-col bg-base-100 rounded-lg shadow-md">
        <input type="hidden" name="csrf_token" value="{$csrf_token}" />
        <div class="flex justify-between">
            <p class='text-xl font-bold'>게시글 작성</p>
