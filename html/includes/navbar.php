<?php
    $navbar_user_id = $_SESSION["user_id"] ?? null;
?>
...
<div class="w-full flex items-center bg-base-100 shadow-sm z-10 px-10 py-2">
    ...
    <div class="flex items-center gap-2">
        ...
        <?php if (isset($navbar_user_id)) {
            echo <<<HTML
                <a href='/profile.php?user_id={$navbar_user_id}'><h2 class='text-lg mr-5'>{$navbar_user_id}</h2></a>
            ...
            echo <<<HTML
                <a href='/login.php'><button class='btn btn-primary'>로그인 / 가입</button></a>
            HTML;
        } ?>
    </div>
</div>
